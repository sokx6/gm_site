...
// NewClient creates a new Client and performs the initial WebSocket handshake
// setup (read deadline for pong).
...
func (c *Client) ReadPump() {
	...
	for {
		...
		// Messages received from clients are broadcast to all connected clients.
